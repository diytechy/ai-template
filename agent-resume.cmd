...
REM docs/log.md, docs/config.toml (the live working surfaces;
...
REM by keeping the slot filled, declaring docs/config.toml, and running this.
...
REM with the policy.review_rounds reviewer dial), e.g.:
