...
- **Active gate:** G1 — Requirements, UX & constraints _(the derived value from
  `docs/gate` — regenerated by `scripts/derive_gate.py`, never hand-set; keep
  this line matching it; see process.md §7)_
- **Round:** 1
