...
_Pending owner actions — a generated projection of durable state (blocked rows, stranded attestations, source conflicts, quarantines, the NEEDS-HUMAN run-state ask); regenerated by `python project-trajectory/scripts/gen_trajectory.py --status`, do not hand-edit. The briefs above are hand-authored and untouched by regeneration._
