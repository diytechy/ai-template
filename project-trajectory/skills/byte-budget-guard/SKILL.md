...
| `project-trajectory/PROCESS.md` | **watched** (baseline **61,824** as of 2026-07-26/WI-321 (+560 on the 61,264 stamp: the stand-alone-requirement rule in §3 — no work-item id and no self-citation in an SR's normative text, stated once here so a downstream adopter inherits the standard and not just the checker); keep flat — re-stamp this number, every tracked skill copy, when a flagged growth lands) | convention + the WI log's byte-delta report |
