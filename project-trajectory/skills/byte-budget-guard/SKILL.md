...
| `project-trajectory/skills/byte-budget-guard/SKILL.md` | **5,000** | 4,878 | 2026-08-24 | +39: WI-455 re-stamped the two watched rows below (PROCESS.md, PROCESS_OPTIONS.md) plus this row's own baseline |
...
|---|---|---|---|
| `project-trajectory/PROCESS.md` | 85,984 | 2026-08-24 | **+122** FLAGGED: WI-455 — §8's field list re-states the seam as `Provider`/`Consumers` and states the omit-when-derivable rule (the prior row pinned 85,889, 27 bytes above the real file) |
