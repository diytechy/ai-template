...
| `project-trajectory/skills/byte-budget-guard/SKILL.md` | **5,000** | 4,829 | 2026-09-01 | WI-553 re-stamped the PROCESS_OPTIONS row (OI-70 blockref retirement) and this row |
...
| `project-trajectory/PROCESS_OPTIONS.md` | 181,369 | 2026-09-01 | **+43** FLAGGED: WI-553 (OI-70) — the lifecycle prose drops the retired `blockref` mechanism from `blocked` (a stopped lane closes PARTIAL). |
