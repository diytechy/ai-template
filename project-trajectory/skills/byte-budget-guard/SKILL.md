...
| `project-trajectory/PROCESS.md` | **watched** (baseline **57,966** as of 2026-07-10/WI-050; keep flat — re-stamp this number, every tracked skill copy, when a flagged growth lands) | convention + the WI log's byte-delta report |
