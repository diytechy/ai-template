...
| `project-trajectory/skills/byte-budget-guard/SKILL.md` | **5,000** | 4,923 | 2026-09-02 | the restructure review re-stamped the PROCESS_OPTIONS row and this one |
...
| `project-trajectory/PROCESS_OPTIONS.md` | 187,162 | 2026-09-02 | **+111** restructure review round 2: R-A's restructured line states the parser's whitespace tolerance, and that a successor is distinct, live and not itself absorbed. Earlier: **+630** `restructured` joins the lifecycle, the Status enum, R-A's terminal set and R-F's carve-out |
