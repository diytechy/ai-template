<!-- DISPATCHER NOTES (stripped before the prompt is sent)
     ...
     Slots: {wi} {title} {srs} {specref} {train} {base} and the five computed
     ...
     four `- WI:`/`- SR-Refs:`/`- Branch:` lines above it already say
