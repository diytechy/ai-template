...
BASELINE = {
    ...
    ("gen_arch_map.py", "main"): 18,  # +1 2026-08-14 WI-455: the required---doc refusal (the scaffolded docs/architecture.md default retired; a bare run must say where the map now lives, not write to a ghost path) — reviewed bump, reason in the log fragment
