...
BASELINE = {
    ...
    (
        "agent_session.py",
        "run_session",
    ): 13,  # -1 (14 -> 13) 2026-08-30 WI-548: the deadline wait extracted OUTWARD to _wait_for_exit (C3)
