...
BASELINE = {
    ...
    "agent_loop.py": 2678,  # 2026-09-06, +65 P0b: one typed code-restart boundary plus durable probe/interactive invocation accounting; existing function complexity ceilings retained.
