...
BASELINE = {
    ...
    "agent_loop.py": 2583,  # -4 (2587 -> 2583 SLOC) 2026-09-04, MERGE of two downward re-stamps: WI-589 deleted the duplicate REVIEW_PHASES tuple (-1, 2026-09-03) and the cognitive-complexity decomposition of worker_endstate (-3, 2026-09-04); measured on the merged tree with check_complexity.module_sloc. Both parents' reasons stand: the duplicate-definition deletion and the outward extraction paid from its own caller. DOWNWARD on both sides, no licence.
