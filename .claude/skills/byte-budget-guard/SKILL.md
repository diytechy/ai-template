...
| `project-trajectory/PROCESS.md` | **watched** (baseline **61,264** as of 2026-07-26/WI-316 fix pass (+90 on the +754 stamp: adversarial-review F6 — restore the dropped word so §7 reads 'no other value carries MECHANICAL meaning', with Planned named as the conventional non-magic middle); keep flat — re-stamp this number, every tracked skill copy, when a flagged growth lands) | convention + the WI log's byte-delta report |
