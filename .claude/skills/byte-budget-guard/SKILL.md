...
| `project-trajectory/PROCESS.md` | **watched** (baseline **58,297** as of 2026-07-11/WI-056; keep flat — re-stamp this number, every tracked skill copy, when a flagged growth lands) | convention + the WI log's byte-delta report |
