...
Session 002: `65f368e7` (ruling (a) recorded), `5f1e262a` (refresh_refusal scoped to the act's write set), `75cdac7d` (refusal text extracted, seam contract states the scope), close `9c8b3ce2` with trailer `WI: WI-584`.
