...
Session 010: `f8c83e32` (trunk regen path driven, gap re-derived by mutation), `95686911` (LLR-208 names the trunk regen row; TC-206 states and cites the driven arm), close `6f274193` with trailer `WI: WI-588` — the tree the round judged.
