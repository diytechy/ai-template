...
Session 001: `05f6bb26` (one definition of the review-phase span; the span's reader declared on IF-175), `b8e445ae` (span crossing recorded in the row's notes). Deliverable filled at `b0be72c7` (the dispatcher's aborted partial close committed the supervisor's edit as-is); spec moved and trailer `WI: WI-589` at `836ccd94` by the supervising session.
