...
- **Next action:** the build frontier is **WI-209** (M2 — dual-plan
  auto-dispatch + quiet-park auto-page, [specs/WI-209.md](specs/WI-209.md));
  **WI-210** (M3 — legacy-path retirement) remains deferred on its declared
  three-real-run bake trigger plus owner un-defer. The WI-208 migration audit
  and live-default proof are recorded in [log.md](log.md). Owner items OI-3
  (the `main`-integration residue) / OI-4 / OI-7 stay open under
