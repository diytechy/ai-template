...
- **The `wi483-core-decomposition` lane is OPEN with slice 1 landed**
  ...
  ruled either way — it was ((d), 2026-08-21), and its execution (2026-08-22)
  confirmed this row's data point rather than overriding it:
  `LLR-182`'s tag stays `CMP-008`, `IF-093` still the declared seam.
...
- **Spine:** **SN=27 SR=73 LLR=169 TC=165** (2 drafts) · 129 seams · 4 components.
