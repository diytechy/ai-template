...
- **Next action:** the review-18 open items are consumed
  (repo-review-2026-07-18.md §6). The queued frontier (scheduler-derived
  order): **WI-225** — the no-new-C901 ratchet (H-02 slice A);
  **WI-226** — the dispatcher decision/effect decomposition (H-02 slice B,
  after WI-225, absorbs the L-04 test split); **WI-227** — the run-menu
