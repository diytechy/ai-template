...
- **Next action:** the M1–M3 dispatcher migration is **complete** (WI-208/209/
  210 done — one engine, one selection path; evidence in [log.md](log.md)), and
  the 2026-07-17 review remediation landed: the `ready --explain` text defect is
  fixed and regression-tested, and blank-`SafetyClass` round children
  quarantining until audited is the ratified fail-closed design, not a residual
  (see [repo-review-2026-07-17.md](repo-review-2026-07-17.md) §0 and the
  second-pass [repo-review-2026-07-17b.md](repo-review-2026-07-17b.md)). The
  registry frontier is the deferred backlog above. Owner items OI-3 (the
  `main`-integration residue — now also carrying the landed migration + review
  commits) / OI-4 / OI-7 stay open under `gate-policy: autonomous`.
