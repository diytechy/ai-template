...
- **Next action:** grinding the **repo-review-2026-07-21 backlog** in
  ...
  **adversarial review** before cherry-pick. Waves 1–3 are **done and
  ...
  see [log.md](log.md); integrated smoke 1060 passed. **Next:** **WI-261**
  (blackout banner + countdown heartbeat), then **WI-262** (Python floor
  3.8→3.11, solo) and **WI-267** (retired Status vocabulary, solo / last). The
  render surface changed in waves 1–2 (edge-router lane-routing + cue/focus
  polish) — a consolidated perceptual critique is owed before the next green G3,
  scheduled at task close.
