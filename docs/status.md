...
- **Active gate:** derived **G1** (per-phase `1=G2;2=G3;3=G3;4=G2;5=G0`, derived current **phase=4**) — the harness at the derived gate is the bar; [`derive_gate.py`](../project-trajectory/scripts/derive_gate.py) computes it, cached to [`docs/gate`](gate).
- **Spine:** **SN=32 SR=146 LLR=147 TC=143** (33 drafts) · 95 seams · 5 components.
