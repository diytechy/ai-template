...
- **Spine:** **SN=25 SR=136 LLR=134 TC=131** (0 drafts) · 86 seams · 5 components.
- **Ready frontier** _(dependency-ready WIs in build order — generated from the scheduler; a closed WI drops out automatically, so this list is never stale and never names a `done` id):_
  - **WI-388** — RULED 2026-07-31 (docs/concurrency-v2.md §A5.2)
  - **WI-389** — RULED 2026-07-31 (docs/concurrency-v2.md, owner direction 2026-07-31)
