...
- **Next action:** the queued frontier: **WI-229** — the M-05 spine
  ...
  last 2026-07-18 parallel-run field finding: **WI-232** — make
  `needs-re-review` actionable (dispatch the focused re-review or page
  NEEDS-HUMAN with the named conflict). (**WI-230** — publication under dirt
  disjoint from the publish diff — and **WI-231** — the integrator regenerates
  generated artifacts on conflict instead of parking + the WI-keyed registry
  union merge — both landed 2026-07-18.) The deferred backlog remains as listed above; owner items OI-3
