...
- **Spine:** **SN=25 SR=136 LLR=130 TC=127** (0 drafts) · 84 seams · 5 components.
- **Ready frontier** _(dependency-ready WIs in build order — generated from the scheduler; a closed WI drops out automatically, so this list is never stale and never names a `done` id):_
  ...
  - **WI-403** — The abandoned-claim oracle excuses EOL-only hand edits (WI-393 REVIEW-A finding 1, minted…
  - **WI-404** — check_figures' placeholder proxy over-approximates (WI-392 REVIEW-A round-2 finding 4, mi…
  - **WI-405** — The refusal anchor trusts bar-shaped text embedded in step output (WI-398 REVIEW-A findin…
  - **WI-406** — Extend WI-399's differential fixtures to the unpinned mirror arms (WI-399 REVIEW-A round-…
  - **WI-407** — Backslash-alias guard in the residue double-lock + correct the report.html rationale (WI-…
  - **WI-408** — spec_move stages a stale index blob when the moved file carries unstaged edits (WI-401 bu…
