...
- **Next action:** **WI-229 landed** 2026-07-19 (the M-05 spine migration:
  ...
  **The queued frontier: WI-242** — dogfood-sync (owner directive
  2026-07-19): adopt the 7 template registry columns this repo's own
  work-items.csv lacks (PlanMode/Priority/Exclusive/BlockRef/critique
  dials/EstTokens) and gate the structural surfaces (registry headers,
  launcher + dev-setup contract lines, stack.ini sections) against template
  drift — values stay free, structure must match.
