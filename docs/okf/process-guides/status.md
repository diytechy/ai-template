...
---
> **GENERATED — a reference copy, not the source of truth.** Derived from docs/status.md by scripts/gen_okf.py; edit the registry/doc, then rerun it (docs/process.toml [checks] okf_export = false silences the layer).
