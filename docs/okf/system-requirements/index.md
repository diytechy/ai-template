...
resource: "generated"
---
> **GENERATED — a reference copy, not the source of truth.** Derived from docs/requirements/system-requirements.toml by scripts/gen_okf.py; edit the registry/doc, then rerun it (docs/process.toml [checks] okf_export = false silences the layer).
...
| [SR-012](SR-012.md) | Doc navigability |
| [SR-013](SR-013.md) | Runtime-flows check |
| [SR-014](SR-014.md) | Perf comparator and budgets |
| [SR-015](SR-015.md) | Performance-budget back-links |
| [SR-016](SR-016.md) | No-stub detector |
| [SR-017](SR-017.md) | Always-on secrets floor |
