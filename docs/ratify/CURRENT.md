...
_Baseline: `docs/archive/last_approved` — copied 2026-09-06 (cde260dd), the commit that last wrote this record._

_Approval provenance: the last commit to move a `Status` cell in a snapshotted registry is 77612fb2 (2026-09-06) — the record's maturity cells have not moved since._
