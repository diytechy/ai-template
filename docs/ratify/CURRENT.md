...
_Approval provenance: the last commit to move a `Status` cell in a snapshotted registry is 4824c0ba (2026-08-30) — the record's maturity cells have not moved since._
