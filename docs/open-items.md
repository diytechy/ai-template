...
- **WI-229** — awaiting owner attestation/ratification on train `p0-g3-WI-229-a28a`: the frozen plan at commit `f57d28f924c9` (`git show f57d28f924c9`); attest, amend, or park the row.
