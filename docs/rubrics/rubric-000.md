...
- **G1** — <a definite, citable thing that must be true; e.g. surfaces meet the
  ground plane with contact shadows consistent with one light source>.
- **G2** — <another; e.g. materials read as their intended substance (metal vs
...
rule — see [`README.md`](README.md)). A verdict cites anchor ids (`B1`, `G2`, …)._
