...
| `docs/architecture.md` code map | `gen_arch_map.py` | Per-module summary, Mermaid dependency diagram, `Implements:` back-links — beneath the hand-written one-page overview (the authored runtime flows live in `docs/runtime-flows.md`, verified by `check_flows.py`). |
