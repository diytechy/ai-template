...
# docs/config.toml (the live working surfaces; IMPROVEMENT_PLAN.md is archived
...
# by keeping the slot filled, declaring docs/config.toml, and running this.
...
# with the policy.review_rounds reviewer dial), e.g.:
