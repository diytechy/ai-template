...
| `project-trajectory/PROCESS.md` | **watched** (baseline **56,375** as of 2026-07-05/WI-1.28; keep flat — re-stamp this number, both skill copies, when a flagged growth lands) | convention + the WI log's byte-delta report |
