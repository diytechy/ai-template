...
| `project-trajectory/PROCESS.md` | **watched** (baseline **61,174** as of 2026-07-26/WI-316 (+754: the canonical Modified re-attest semantics in §7 — the third recognized Status value, both flips, the same-commit rule; the one-home statement every other surface links to); keep flat — re-stamp this number, every tracked skill copy, when a flagged growth lands) | convention + the WI log's byte-delta report |
