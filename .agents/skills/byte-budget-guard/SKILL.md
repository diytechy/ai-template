...
| `project-trajectory/skills/byte-budget-guard/SKILL.md` | **5,000** | 4,851 | 2026-09-02 | the restructure review re-stamped the PROCESS_OPTIONS row and this one |
...
| `project-trajectory/PROCESS_OPTIONS.md` | 187,051 | 2026-09-02 | **+630** `restructured` joins the lifecycle, the folder list, the Status enum, R-A's terminal set and R-F's carve-out. Earlier: **+866** WI-572 round 028; **+3,691** WI-572 "Who performs the approval act" |
